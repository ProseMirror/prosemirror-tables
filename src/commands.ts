 ...
 * @public
 */
export let toggleHeaderRow: Command = toggleHeader('row', {
 ...
 * @public
 */
export let toggleHeaderColumn: Command = toggleHeader('column', {
  useDeprecatedLogic: true,
});
 ...
 * @public
 */
export let toggleHeaderCell: Command = toggleHeader('cell', {
  useDeprecatedLogic: true,
});
